...
class BraxAdapter:
    ...
    env : brax.envs.base.Env
        The Brax environment to wrap.

    Examples
    --------
    >>> import brax.envs
    >>> env = BraxAdapter(brax.envs.get_environment("inverted_pendulum"))
    ...
    def __init__(self, env: Any) -> None:
        if isinstance(env, brax_training.AutoResetWrapper):
            raise ValueError(
                "Brax AutoResetWrapper detected. Use parallax.wrappers.AutoResetWrapper instead."
            )
